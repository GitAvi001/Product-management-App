...
fetchProduct: async (id) => {
  ...
  try {
    ...
    set({
      currentProduct: response.data.data, //current form data updating to the new product details
...
updateProduct: async (id) => {
  ...
  try {
    ...
    set({ currentProduct: response.data.data }); //sets new data to the current product data
